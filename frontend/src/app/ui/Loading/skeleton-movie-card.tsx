            ...
            <div className="tablet:hidden phone:hidden flex h-[80%] desktop:gap-10 laptop:gap-[25px] tablet:gap-[25px] phone:gap-[20px] w-full overflow-x-hidden">
              {[...Array(5)].map((_, index) => (
                <Card
                  ...
                  key={index}
                >
                    <Skeleton className="skeleton dark desktop:h-[340px] h-[270px] rounded-lg bg-default200"></Skeleton>
                    <div className="space-y-3">
                        <Skeleton className="skeleton dark desktop:h-[40px] h-6 w-4/5 rounded-lg bg-default200"></Skeleton>
                    </div>
                </Card>
              ))}
            </div>
            ...
            <div className="laptop:hidden desktop:hidden flex h-[80%] desktop:gap-10 laptop:gap-[25px] tablet:gap-[25px] phone:gap-[20px]">
              {[...Array(3)].map((_, index) => (
                <Card
                  ...
                  key={index}
                >
                    <Skeleton className="dark desktop:h-[340px] h-[270px] rounded-lg bg-default200"></Skeleton>
                    <div className="space-y-3">
                    <Skeleton className=" dark desktop:h-[40px] h-6 w-4/5 rounded-lg bg-default200"></Skeleton>
                  </div>
                </Card>
              ))}
            </div>
  ...
  return (
    <div className="mt-[5%]">
      <div className="flex flex-wrap mx-[11%] flex-col items-center gap-6 mt-6 w-full my-[60px] tablet:max-w-[600px] laptop:max-w-[1200px] phone:max-w-[350px]">
          <Skeleton className="h-8 w-[400px] dark phone:w-[120px] tablet:w-[250px] rounded-lg bg-[#15202b]">
