  ...
  return (
    <>
      {user ? (
        ...
        <div className="bg-secondary w-full flex justify-center p-2 rounded border-white border">
          <Link href="/login" className="w-full hover:bg-tertiary text-center rounded-md transition-all">Sign in Account to add comment</Link>
        </div>
      )}
    </>
  );
