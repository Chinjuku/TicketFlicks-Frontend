...
const Navbar = () => {
  ...
  return (
    <div
      className={`bg-gradient-to-b from-black from-30% via-primary1 via-50% to-black desktop:h-[196px] laptop:h-[140px] tablet:h-[150px] phone:h-[97px] flex fixed top-0 z-[1000] w-full`}
    >
      ...
      <div className="tablet:hidden phone:hidden w-full flex">
        ...
        <div className="w-[74%] flex items-center hide">
          <div className="navbox-desktop navbox-laptop drop-shadow-[0_35px_35px_rgba(60,60,60,0.25)] border-secondary1 bg-none w-full flex items-center">
      ...
      <div className={clsx("h-full fixed right-0 px-5 transition-all bg-secondary1", {
        "w-0 opacity-0": !open,
